...
const links = [
  ...
  { nombre: "Registrar empleado pensionado", ruta: "/empleado/nuevo_pensionado", disabled: true },
];
...
export default function RegistroUsuarioPensionadoEmpleado({ onCancel, onSubmit }) {
  ...
  const handleAgregarVehiculo = (formValues) => {
    ...
    navigate("/empleado/nuevo_pensionado/vehiculo", {
      state: { usuarioData },
    });
  };
