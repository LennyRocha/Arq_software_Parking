...
const links = [
  { nombre: "Inicio", ruta: "/empleado", disabled: false },
  { nombre: "Registrar empleado pensionado", ruta: "/empleado/nuevo_pensionado", disabled: false },
  { nombre: "Registrar vehículo", ruta: "/empleado/nuevo_pensionado/vehiculo", disabled: true },
];

export default function RegistroVehiculoEmpleado({ onCancel, onFinalizar }) {
  ...
  const handleCancel = () => {
    if (onCancel) {
      ...
      navigate("/empleado/nuevo_pensionado", { state: { usuarioData } });
    }
  };
